...
public class ReflectUtils {
	...
	/**
	 * 获取指定Class指定属性的list集合中元素的Class类型
	 * 
	 * @return Class<?>
	 * @date 2016年7月12日下午3:40:38
	 */
	public static Class<?> getListInnerClass(Class<?> clazz, String propertyName) {
		Field field = null;
		try {
	 ...
	 * @date 2016年7月12日下午3:40:38
	 */
	public static Class<?> getListInnerClass(Field field) {
		Class<?> type = null;
		if (!field.getType().isAssignableFrom(List.class)) {
			return type;
		}
